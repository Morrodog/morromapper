...
//import dominionsOfDust             from '/src/mock-database/releases/dominions-of-dust.json'
//import thirrValley                 from '/src/mock-database/releases/thirr-valley.json'

const releases = [antediluvianSecrets, sacredEastUpdate, oldEbonheart, sacredEast, aanthirrin, telvannis, vvardenfell, solstheim, firemoth, imperialTelvannisOverhaul/*, thirrValley, dominionsOfDust*/];
...
import ro5 from '/src/mock-database/exterior-claims/RO_5.json'

const exteriorClaims = [ro1, ro2, ro3, ro4, ro5];

import dreughmora from '/src/mock-database/quest-claims/revenge-of-the-dreughmora.json'
import sevenseas  from '/src/mock-database/quest-claims/seven-seas-too-many.json'
import betrayal   from '/src/mock-database/quest-claims/betrayal-by-any-other-name.json'
import swegging   from '/src/mock-database/quest-claims/swegging.json'
import kitchen    from '/src/mock-database/quest-claims/infernal-kitchen.json'
...
import feast      from '/src/mock-database/quest-claims/a-feast-for-daedra.json'
import apple      from '/src/mock-database/quest-claims/apple-without-pith.json'
import kevin      from '/src/mock-database/quest-claims/kevin-sees-two.json'
import roses      from '/src/mock-database/quest-claims/roses-kin.json'
import kith       from '/src/mock-database/quest-claims/without-kith.json'

const questClaims = [dreughmora, liberty, missing, davis, feast, apple, betrayal, kitchen, kevin, roses, sevenseas, swegging, kith];
...
import forgotten   from '/src/mock-database/interior-claims/forgotten-temple.json'
import octo        from '/src/mock-database/interior-claims/octostadium.json'
import rosesboats  from '/src/mock-database/interior-claims/roses-boats.json'
import steveshack  from '/src/mock-database/interior-claims/steve-shack.json'
import swallow     from '/src/mock-database/interior-claims/swallow-armory.json'
import underopolis from '/src/mock-database/interior-claims/underopolis.json'
import velcrom     from '/src/mock-database/interior-claims/velothi-necrom.json'
import sand        from '/src/mock-database/interior-claims/sand-dollary.json'

const interiorClaims = [ interior1, interior2, interior3, interior4, interior5 , interior6 , interior7 , interior8 , interior9 , interior10, interior11, interior12, interior13, interior14, interior15, interior16, interior17, interior18, interior19, interior20, interior21, interior22, interior23, interior24, interior25, interior26, interior27, interior28, interior29, interior30, interior31, interior32, interior33, interior34, interior35, interior36, interior37, forgotten, octo, rosesboats, steveshack, swallow, underopolis, velcrom, sand];
